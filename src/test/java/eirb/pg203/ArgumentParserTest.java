...
class ArgumentParserTest {
    ...
    void testValidDateRange() {
        CliConfig config = parser.parse(new String[]{"f.ics", "events", "-from", "20250101", "-to", "20250131"});
        assertNotNull(config);
    ...
    void testLogicDateErrors() {
        runWithSilentErr(() -> {
            ...
            //from après To
            assertNull(parser.parse(new String[]{"f.ics", "events", "-from", "20250201", "-to", "20250101"}));
        });
    }
}