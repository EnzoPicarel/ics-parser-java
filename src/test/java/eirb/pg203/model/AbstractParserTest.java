...
public class AbstractParserTest {
    ...
    void testFirstEvent() {
        ...
        assertEquals(createExpectedDate("20251104T215832Z"), e.creation_date); // ou e.creation_date selon ton nom
    ...
    public void testUrlSelection() {
        ...
        // Cela va échouer silencieusement (retour vide) car l'URL n'existe pas, mais ça ne doit pas crasher.
